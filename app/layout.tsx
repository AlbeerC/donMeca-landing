...
export const metadata: Metadata = {
  ...
  twitter: {
    ...
    description:
      "Orden para tu taller, tiempo para vos. Controlá trabajos, clientes, stock y caja sin complicaciones.",
  ...
  category: "technology",
  icons: {
    icon: "/donmeca-logo.png",
    shortcut: "/donmeca-logo.png",
    apple: "/donmeca-logo.png",
  },
};
